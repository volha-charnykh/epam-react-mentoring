...
jest.mock('../../general/components/tabs/tabs', () => (props) => (
  <div
    className="TestTab"
    onClick={() => props.onTabClicked(props.activeTab)}
  >
    {props.children}
    {props.right}
  </div>
));
jest.mock('../../general/components/dropdown/dropdown', () => (props) => (<div onClick={() => props.onItemSelected({ filmField: 'any' })}>TestItem</div>));
